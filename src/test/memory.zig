...
test "memory 8b register" {
    var creation = try maker.Creation.init(allocator, 4 * 3, 4 * 3);
    ...
    try testing.expectEqualStrings("3,,2,0,0,;1,,1,0,0,;5,,0,0,0,;3,,2,1,0,;1,,1,1,0,;5,,0,1,0,;3,,2,2,0,;1,,1,2,0,;5,,0,2,0,;3,,2,3,0,;1,,1,3,0,;5,,0,3,0,?1,2;2,3;3,1;4,5;5,6;6,4;7,8;8,9;9,7;10,11;11,12;12,10?", out.items);
}
