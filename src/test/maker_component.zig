...
test "component add connection" {
  ...
  try testing.expectEqualStrings(
    ...
    component.creation.connections.items
  );
}
...
test "component compile" {
  ...
  try testing.expectEqualStrings(
    "1,,-11,4,3,;3,,,,,;1,,1,1,1,;6,,11,-9,2544,123+123+23;10,,,,,-12+0+0+0+3434;4,,1,1,1,?0,0;1,2;12,934213;77777777,4435546;9999,9999;9999,1234?",
    out.items
  );
}
